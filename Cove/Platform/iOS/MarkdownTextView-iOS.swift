...
struct MarkdownTextView: UIViewRepresentable {
    ...
    final class Coordinator: NSObject, UITextViewDelegate, UIGestureRecognizerDelegate {
        ...
        func textView(_ textView: UITextView,
            ...
            let edited = NSRange(location: range.location,
                                 length: max(range.length,
            ...
            guard let textView,
                  let checkbox = MarkdownParser.parse(textView.text)
                    .checkboxes.first(where: {
                        NSLocationInRange(textView.selectedRange.location,
                                          $0.markerRange)
        ...
        private func setCheckbox(in textView: UITextView,
                                 range: NSRange,
                                 status: String) {
...
private final class CheckboxTogglingTextView: UITextView {
    ...
    override var keyCommands: [UIKeyCommand]? {
        [UIKeyCommand(title: "Toggle Checkbox",
